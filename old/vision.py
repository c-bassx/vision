...
#model.load_state_dict(torch.load(pt_path)['state_dict'])
#model.eval()
    ...
    with dai.Device(pipeline) as device:
        ...
        while True:
            ...
            for index, detection in enumerate(detections, start=1):
                ...
                print(f"xmax: {detection.xmax}")
                print(f"ymax: {detection.ymax}")
                ...
                cv2.drawMarker(frame, (obj_center_x, obj_center_y), color=(0, 0, 255), markerType=cv2.MARKER_CROSS, thickness=2)
